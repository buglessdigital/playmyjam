    ...
    <BilingualLegal
        ...
        <main className="max-w-3xl mx-auto px-6 pb-16 pt-6 text-white">
          ...
          <section className="mb-8">
            ...
            <ul className="text-gray-300 leading-relaxed list-disc list-inside space-y-2">
              ...
              <li>
                <strong>Saklı kart anahtarı:</strong> Ödeme formunda &quot;kartımı sakla&quot;
                seçeneğini işaretlerseniz kartınız iyzico&apos;nun kart saklama hizmetinde saklanır.
                Tarafımıza yalnızca iyzico&apos;nun ürettiği, kart numarası içermeyen bir anahtar
                (cardUserKey) iletilir; bu anahtar sonraki ödemelerinizde saklı kartlarınızın
                gösterilmesi için hesabınızla ilişkilendirilir.
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <ul className="text-gray-300 leading-relaxed list-disc list-inside space-y-2">
              ...
              <li>
                Talep etmeniz hâlinde, saklı kartınızla sonraki ödemelerin kart bilgisi yeniden
                girilmeden yapılabilmesi.
              </li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 leading-relaxed">
              ...
              Saklı kart anahtarı hesabınızla birlikte silinir. iyzico nezdinde saklanan kartınızın
              silinmesini dilediğiniz zaman {COMPANY.email} adresine ya da doğrudan iyzico&apos;ya
              başvurarak talep edebilirsiniz.
            </p>
          </section>
      ...
      en={
        <main className="max-w-3xl mx-auto px-6 pb-16 pt-6 text-white">
          ...
          <p className="text-gray-400 mb-10 text-sm">Last updated: 21 September 2026</p>
          ...
          <section className="mb-8">
            ...
            <ul className="text-gray-300 leading-relaxed list-disc list-inside space-y-2">
              ...
              <li>
                <strong>Saved card key:</strong> If you tick &quot;save my card&quot; on the payment
                form, your card is stored by iyzico&apos;s card storage service. We receive only a key
                generated by iyzico (cardUserKey) that contains no card number; it is linked to your
                account so your saved cards can be offered on later payments.
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <ul className="text-gray-300 leading-relaxed list-disc list-inside space-y-2">
              ...
              <li>At your request, letting you pay with a saved card without re-entering it.</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-300 leading-relaxed">
              ...
              The saved card key is deleted together with your account. You can ask for a card stored
              by iyzico to be removed at any time by writing to {COMPANY.email} or contacting iyzico
              directly.
            </p>
          </section>
