  ...
  return (
    <div style={{ background: "#0f0a18", minHeight: "100dvh", width: "100%" }}>
      <div style={{ padding: "48px 20px 16px" }}>
        ...
        <div style={{ height: 48, borderRadius: 16, background: "rgba(255,255,255,0.08)" }} className="animate-pulse" />
      </div>
      ...
      <div style={{ padding: "0 20px 120px", display: "flex", flexDirection: "column", gap: 0 }}>
        {[1, 2, 3, 4, 5, 6, 7].map((i) => (
          <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, padding: "14px 0", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
            ...
            <div style={{ width: 36, height: 36, borderRadius: "50%", background: "rgba(255,255,255,0.08)", flexShrink: 0 }} className="animate-pulse" />
          </div>
        ))}
      </div>
    </div>
